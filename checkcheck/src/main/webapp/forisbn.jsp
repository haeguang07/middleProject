...
<body>
	...
	<script>
		...
		/* var id = main.attr("id").substr(16); */
		  ...
		  var url2 = "http://www.aladin.co.kr/ttb/api/ItemSearch.aspx?ttbkey=ttbhbj040030858001&cover=big&MaxResults=100&query=h&output=js&callback=bookDisplay";
...
//			COVER                  VARCHAR2(100)  
	 ...
	 // AJAX 요청을 보냅니다. getJSON() 함수는 알라딘 API 대용으로 사용불가.
		  $.ajax({
		     url: "http://www.aladin.co.kr/ttb/api/ItemLookUp.aspx?ttbkey=ttbhbj040030858001&cover=big&MaxResults=100&itemIdType=ISBN13&itemId=9791159922886&output=js&callback=bookDisplay",
		     jsonp: "bookDisplay",
		     dataType: "jsonp"
		  });
